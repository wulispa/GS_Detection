...
//
//// 注意这里原先是utils，由于命名空间跟cv的一个重复，所以改了
//namespace dl_utils 
//{
//    /************************************************************************************************
//    * array
...
//
//        const std::vector<std::string> bottle1 = { "ng" };
//
//        const std::vector<std::string> bottle_top = { "Dirty","Scratch" ,"Crack" ,"Spot" ,"Deformation" ,"Bubble" };
//    }
...
//
//    std::vector<unsigned char> loadEncryptModel(const std::string& file);
//
