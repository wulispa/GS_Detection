...
void putText00::GetStringSize(HDC hdc, const char* str, int* w, int* h)
{
    SIZE size;
...
void putText00::putTextZH(Mat& dst, const char* str, Point org, Scalar color, int fontsize, const char* fn, bool italic, bool underline)
{
